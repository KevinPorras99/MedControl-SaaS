...
export default function LightPillar({
  ...
  useEffect(() => {
    ...
    // Use window dimensions as reliable fallback
    ...
    const frameTime = 1000 / (effectiveQuality === 'low' ? 30 : 60)
  ...
  }, [topColor, bottomColor, intensity, rotationSpeed, interactive, glowAmount,
      pillarWidth, pillarHeight, noiseIntensity, pillarRotation, webGLSupported, quality])
